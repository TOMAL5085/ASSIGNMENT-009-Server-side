...
const tutors = [
  ...
  },
  {
    ...
    hourlyFee: 20,
    totalSlot: 10,
    sessionStartDate: new Date("2026-04-28"),
    institution: "BUET",
  ...
  },
  {
    ...
    hourlyFee: 17,
    totalSlot: 9,
    sessionStartDate: new Date("2026-04-24"),
  ...
  },
  {
    ...
    hourlyFee: 16,
    totalSlot: 11,
    sessionStartDate: new Date("2026-05-03"),
  ...
  },
  {
    ...
    hourlyFee: 15,
    totalSlot: 14,
    sessionStartDate: new Date("2026-04-26"),
  ...
  },
  {
    ...
    hourlyFee: 19,
    totalSlot: 8,
    sessionStartDate: new Date("2026-05-04"),
  ...
  },
  {
    ...
    hourlyFee: 18,
    totalSlot: 10,
    sessionStartDate: new Date("2026-05-02"),
  ...
  },
  {
    ...
    hourlyFee: 17,
    totalSlot: 13,
    sessionStartDate: new Date("2026-04-30"),
  ...
  },
  {
    ...
    hourlyFee: 21,
    totalSlot: 7,
    sessionStartDate: new Date("2026-04-22"),
...
async function seedTutors() {
  ...
  const inserted = await Tutor.insertMany(docs);
  console.log(`Inserted ${inserted.length} tutors.`);
